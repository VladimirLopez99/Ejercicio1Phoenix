defmodule PetClinic3.PetClinicServiceTest do
  use PetClinic3.DataCase

  alias PetClinic3.PetClinicService

  describe "pets" do
    alias PetClinic3.PetClinicService.Pet

    import PetClinic3.PetClinicServiceFixtures
